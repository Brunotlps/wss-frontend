<template>
  <div class="flex flex-col overflow-hidden rounded-xl border border-gray-200 bg-white">
    ...
    <div class="flex flex-col gap-3 p-4">
      ...
      <div class="h-3 w-1/3 animate-pulse rounded bg-gray-200" />
      <div class="flex items-center justify-between pt-1">
        <div class="h-6 w-16 animate-pulse rounded bg-gray-200" />
        <div class="h-8 w-20 animate-pulse rounded-md bg-gray-200" />
      </div>
    </div>
  </div>
</template>
