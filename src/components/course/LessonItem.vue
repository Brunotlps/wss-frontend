...
<template>
  <button
    ...
    :class="isActive ? 'bg-dm-navy-700 text-white' : 'text-dm-navy-200 hover:bg-dm-navy-700/50 hover:text-white'"
  ...
  >
      ...
      :class="
        isCompleted
          ...
          : isActive
            ...
            : 'border border-dm-navy-600 text-dm-navy-200'
      "
    >
      <svg
        v-if="isCompleted"
    ...
    <div class="min-w-0 flex-1">
      ...
      <p class="mt-0.5 text-xs" :class="isActive ? 'text-dm-gold/70' : 'text-dm-navy-200/60'">
